...
class DismissActivity implements Activity {
	...
	private static final ActivityDescriptor ACTIVITY_DESCRIPTOR = ActivityDescriptor.builder().route("music dismiss")
			.description("Makes me leave the voice channel.").build();

	private final BotUtils botUtils;

	@Inject
	public DismissActivity(BotUtils botUtils) {
